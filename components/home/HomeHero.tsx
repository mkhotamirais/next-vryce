    ...
    <section className="py-12 md:pt-28 md:pb-18">
      <div className="container relative">
        ...
        <div className="flex flex-col items-start sm:items-center text-left sm:text-center max-w-4xl mx-auto space-y-6">
          <motion.h1 variants={fades} initial="hide" animate="show" className="text-5xl md:text-6xl font-bold">
            {title}
          </motion.h1>
          <motion.div
            variants={fades}
          ...
          <motion.div variants={fades} custom={{ delay: 0.2 }} initial="hide" animate="show" className="flex gap-2">
