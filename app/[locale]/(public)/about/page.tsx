...
export default function About({ params }: Props) {
  ...
  return (
    <div className="scroll-mt-12 md:scroll-mt-16">
      ...
      <section className="py-12 lg:py-20 bg-[radial-gradient(circle_at_top_right,rgba(41,98,255,0.10)_0%,transparent_20%),radial-gradient(circle_at_left_bottom,rgba(41,98,255,0.10)_0%,transparent_40%)]">
        ...
        <div className="container flex flex-col lg:flex-row gap-8 lg:gap-16">
          <div className="w-full h-80 lg:w-1/3 order-2 lg:order-1">
            <Image
